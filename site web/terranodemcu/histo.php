...
session_start(); // pour pouvoir utiliser les sessions
  ...
  if(empty($_POST))
		{
		  $limit = 1440;
		  $graphe = 'datamoyh.php';
		  $titre = "<strong>Historique du terrarium des dernières 24 heures </strong><em>(Données lissées, moyenne/heure)</em>";			  
		}
  ...
  if(!empty($_POST))
  {
		...
		if ($graphe == 'data.php') {	
			switch ($limit) {
				case "1440":
					$titre = "<strong>Historique du terrarium des dernières 24 heures </strong><em>(Données lissées, moyenne/minute)</em>";
					break;
				case "7200":
					$titre = "<strong>Historique du terrarium des 5 derniers jours </strong><em>(Données lissées, moyenne/minute)</em>";
					break;				
			}				
		} 
		...
		{ 
			switch ($limit) {
				case "1440":
					...
					break;
				case "7200":
					$titre = "<strong>Historique du terrarium des 5 derniers jours </strong><em>(Données lissées, moyenne/heure)</em>";
					break;
			}				
		}
  }
...
<section>	<!-- corps de page -->	
    ...
    <p>
	   <select id="graphe" name="graphe">
		   ...
		   <option value="data.php" <?php if ($graphe == "data.php") { echo 'selected="selected"'; }?> >Données lissées, moyenne/minute</option>

		   <option value="datamoyh.php" <?php if ($graphe == "datamoyh.php") { echo 'selected="selected"'; }?> >Données lissées, moyenne/heure</option>							   
	   ...
	   <select id="limit" name="limit" >
		   ...
		   <option value="7200" <?php if ($limit == 7200) { echo 'selected="selected"'; }?> >Les 5 derniers jours</option>		     				   
